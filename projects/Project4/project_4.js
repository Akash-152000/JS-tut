// const secNum = Math.round(Math.random()*100)
// console.log(secNum);
...
//     if(remGuesses > 0 && input > secNum){
//         prevGuessArr.push(input);
//         prevGuess.innerHTML = prevGuessArr
//         remGuesses = remGuesses - 1
//         remainingGuesses.innerHTML = `<span>${remGuesses}</span>`
//         lowOrHigh.innerHTML = 'High'
//     }else if(remGuesses > 0 && input < secNum){
//         prevGuessArr.push(input);
//         prevGuess.innerHTML = prevGuessArr
//         remGuesses = remGuesses - 1
//         remainingGuesses.innerHTML = `<span>${remGuesses}</span>`
...
//     }
//     else if(remGuesses > 0 && input === secNum){
//         lowOrHigh.innerHTML = 'Winner'
//     }
//     else{
//         lowOrHigh.innerHTML = 'Loser'
//     }
// })
